...
func (whc TestWebhookContext) Init(w http.ResponseWriter, r *http.Request) error { panic("Not implemented")}
...
func (whc TestWebhookContext) ReplyByBot(m MessageFromBot) error { panic("Not implemented")}
...
func (whc TestWebhookContext) NewMessageByCode(messageCode string, a ...interface{}) MessageFromBot { panic("Not implemented")}
...
func (whc TestWebhookContext) GetOrCreateUser() (*datastore.Key, UserEntity, error) { panic("Not implemented")}
