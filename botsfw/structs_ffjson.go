...
func (j *BaseHandler) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	/* Interface types must use runtime reflection. type=botsfw.WebhookDriver kind=interface */
	err = buf.Encode(j.WebhookDriver)
	if err != nil {
		return err
	}
	buf.WriteString(`,"BotHost":`)
	/* Interface types must use runtime reflection. type=botsfw.BotHost kind=interface */
	err = buf.Encode(j.BotHost)
	if err != nil {
		return err
	}
	buf.WriteString(`,"BotPlatform":`)
	/* Interface types must use runtime reflection. type=botsfw.BotPlatform kind=interface */
	err = buf.Encode(j.BotPlatform)
	if err != nil {
		return err
	}
	buf.WriteString(`,"TranslatorProvider":`)
	/* Falling back. type=botsfw.TranslatorProvider kind=func */
...
handle_WebhookDriver:
	...
	/* handler: j.WebhookDriver type=botsfw.WebhookDriver kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.WebhookDriver kind=interface */
...
handle_BotHost:
	...
	/* handler: j.BotHost type=botsfw.BotHost kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.BotHost kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_BotPlatform:
	...
	/* handler: j.BotPlatform type=botsfw.BotPlatform kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.BotPlatform kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_TranslatorProvider:
	...
	/* handler: j.TranslatorProvider type=botsfw.TranslatorProvider kind=func quoted=false*/
...
func (j *EntryInput) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	/* Interface types must use runtime reflection. type=botsfw.WebhookEntry kind=interface */
	err = buf.Encode(j.Entry)
	if err != nil {
		return err
	}
	buf.WriteString(`,"Input":`)
	/* Interface types must use runtime reflection. type=botsfw.WebhookInput kind=interface */
...
handle_Entry:
	...
	/* handler: j.Entry type=botsfw.WebhookEntry kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.WebhookEntry kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_Input:
	...
	/* handler: j.Input type=botsfw.WebhookInput kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.WebhookInput kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_Inputs:
	...
	/* handler: j.Inputs type=[]botsfw.WebhookInput kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJInputs type=botsfw.WebhookInput kind=interface quoted=false*/
...
func (j *MessageFromBot) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if j.ToChat != nil {
		...
		/* Interface types must use runtime reflection. type=botsfw.ChatUID kind=interface */
	...
	if j.BotMessage != nil {
		...
		/* Interface types must use runtime reflection. type=botsfw.BotMessage kind=interface */
	...
	if j.Keyboard != nil {
		...
		/* Interface types must use runtime reflection. type=botsfw.Keyboard kind=interface */
	...
	if j.EditMessageUID != nil {
		...
		/* Interface types must use runtime reflection. type=botsfw.MessageUID kind=interface */
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'F':
					...
					if bytes.Equal(ffjKeyMessageFromBotFormat, kn) {
...
handle_ToChat:
	...
	/* handler: j.ToChat type=botsfw.ChatUID kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.ChatUID kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_BotMessage:
	...
	/* handler: j.BotMessage type=botsfw.BotMessage kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.BotMessage kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_Format:
	...
	/* handler: j.Format type=botsfw.MessageFormat kind=int quoted=false*/
...
handle_Keyboard:
	...
	/* handler: j.Keyboard type=botsfw.Keyboard kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.Keyboard kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
handle_EditMessageUID:
	...
	/* handler: j.EditMessageUID type=botsfw.MessageUID kind=interface quoted=false*/

	{
		/* Falling back. type=botsfw.MessageUID kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
