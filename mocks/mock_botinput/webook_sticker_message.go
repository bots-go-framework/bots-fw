...
// MockWebhookStickerMessage is a mock of StickerMessage interface.
...
func (m *MockWebhookStickerMessage) Chat() botinput.Chat {
	m.ctrl.T.Helper()
...
func (m *MockWebhookStickerMessage) GetRecipient() botinput.Recipient {
	m.ctrl.T.Helper()
...
func (m *MockWebhookStickerMessage) GetSender() botinput.User {
	m.ctrl.T.Helper()
...
func (m *MockWebhookStickerMessage) InputType() botinput.Type {
	m.ctrl.T.Helper()
